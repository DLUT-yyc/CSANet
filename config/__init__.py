...
class Parameters():
    def __init__(self):
        ...
        parser.add_argument("--dataset", type=str, default="cityscapes_train_fine",
                            help="Specify the dataset to use.")
        parser.add_argument("--batch-size", type=int, default=1,
                            help="Number of images sent to the network in one step.")
        parser.add_argument("--data-dir", type=str, default='/media/8TB/yichen/cityscapes',
        ...
        parser.add_argument("--save-pred-every", type=int, default=100,
                            help="Save summaries and checkpoint every often.")
        parser.add_argument("--snapshot-dir", type=str, default='./checkpoint/snapDDP/',
        ...
        parser.add_argument("--warp_loss", type=str, default='L2')
        ...
        parser.add_argument("--use-val", type=str2bool, nargs='?', const=False,
                            help="choose whether to use the validation set to train.")
        parser.add_argument("--use-extra", type=str2bool, nargs='?', const=False,
        ...
        parser.add_argument("--output-path", type=str, default='./dlut_output/',
